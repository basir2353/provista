            ...
            <div className="admin-form-grid">
              ...
              {selected.resumeFile && (
                <div className="admin-form-group full">
                  ...
                  <a href={`${process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000"}/uploads/${selected.resumeFile}`} target="_blank" className="admin-btn admin-btn-secondary admin-btn-sm">Download Resume</a>
                </div>
              )}
            </div>
          </div>
