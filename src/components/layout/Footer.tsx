...
import { buildWhatsAppUrl } from "@/components/WhatsAppChat";
...
const SOCIALS = [
  ...
  { key: "social_twitter", label: "Twitter", icon: <IconTwitter /> },
...
export default function Footer() {
  ...
  const tagline =
    ...
    "Transforming careers through expert resume writing, ATS optimization, and professional storytelling since 2015.";
              ...
              {SOCIALS.map(({ key, label, icon }) => {
                ...
                return (
                  <a
                    key={key}
                    href={href}
                    className={`footer-social footer-social-${key.replace("social_", "")}`}
                    target="_blank"
