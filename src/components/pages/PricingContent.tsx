...
function PlanCard({
  ...
  return (
    ...
    >
      ...
      <p className="plan-guarantee" style={plan.popular ? { color: "rgba(255,255,255,0.4)" } : undefined}></p>
    </div>
  );
}
      ...
      <section className="guarantee-section">
        <div className="container">
          ...
          <div className="guarantee-icons">
            <div className="guarantee-item reveal"><div className="guarantee-icon-wrap">⚡</div><div className="guarantee-title">Fast Turnaround</div><div className="guarantee-desc">Get your resume back within 24-48 hours.</div></div>
