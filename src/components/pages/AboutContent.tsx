        ...
        <div className="container">
          <div className="story-grid">
            <div>
              ...
              <p className="story-intro reveal" style={{fontSize: "15px"}}>Today, our team of certified writers serves clients from entry-level graduates to Fortune 50+ executives, spanning over 10+ industries and 25+ countries. We combine human expertise with cutting-edge ATS technology to give every client the best possible chance at the job they deserve.</p>
            ...
            <div className="story-timeline reveal">
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-desc">Grew to a team of 5 certified writers, serving clients across North America and expanding into the UK market.</div>
              </div>
              <div className="timeline-item">
                <div className="timeline-dot"></div>
        ...
        <div className="container">
          <div className="why-grid">
            <div>
              ...
              <p className="reveal" style={{color: "var(--gray-500)", fontSize: "16px", margin: "16px 0 36px", lineHeight: "1.7"}}>There are hundreds of resume services out there. Here's why 12,000+ professionals chose us:</p>
              <div className="why-list">
                <div className="why-item reveal"><div className="why-icon">👤</div><div><div className="why-title">100% Human-Written, Always</div><div className="why-desc">Every resume is crafted by a certified human writer who specializes in your exact industry. We never use AI to write your resume.</div></div></div>
